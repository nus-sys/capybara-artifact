...
class capybara_switch_fe():
    ...
    def __init__(self, default_ttl=60000):
        self.p4 = bfrt.capybara_switch_fe_fig11.pipe
    ...
    def aging_cb(dev_id, pipe_id, direction, parser_id, entry):
        smac = bfrt.capybara_switch_fe_fig11.pipe.Ingress.smac
        dmac = bfrt.capybara_switch_fe_fig11.pipe.Ingress.dmac
    ...
    def learning_migration(dev_id, pipe_id, direction, parser_id, session, msg):
        # migrate_request = bfrt.capybara_switch_fe_fig11.pipe.Ingress.migrate_request
        # migrate_reply = bfrt.capybara_switch_fe_fig11.pipe.Ingress.migrate_reply
...
port_mirror_setup_file="/home/singtel/inho/fig11/setup_port_mirror_fig11.py" # <== To Modify and Add
